...
# Change Log: (Dominic Verretto, Sep 11, 2024, Assignment 07)
#   RRoot,1/1/2030,Created Script
#   <Dominic Verretto>,<Sep 11, 2024>,<Added script for Assignment 07>
# ------------------------------------------------------------------------------------------ #
import json
...
class Person:
    '''
    A class for adding a generic person to the enrollments list.
    '''
    first_name: str
    last_name: str
...
class Student(Person):
    '''
    A class that adds a student to the enrollments list. Builds off of the person class and
    adds course name
    '''
    course_name: str
